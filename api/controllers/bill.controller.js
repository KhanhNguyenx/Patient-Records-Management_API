...
module.exports.getList = async (req, res) => {
  ...
  const count = await Bill.countDocuments(find);
  ...
  const records = await Bill.find(find)
    .sort(sort)
