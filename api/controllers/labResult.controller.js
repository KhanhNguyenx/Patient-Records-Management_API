...
module.exports.getList = async (req, res) => {
  ...
  const count = await labResult.countDocuments(find);
  ...
  const records = await labResult.find(find)
    .sort(sort)
...
module.exports.create = async (req, res) => {
  try {
    const record = new labResult(req.body);
...
// [PATCH] /api/labresult/restore/:id
